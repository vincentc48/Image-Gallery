...
class Login extends React.Component{
    ...
    changeText = (event) =>{
        ...
        if(this.state.registerInvalid!=="") this.setState({registerInvalid: ""})
    ...
    register = () => {
        axios.post("/auth/register",{username: this.state.registerUsername,password:this.state.registerPassword})
            .then(res=>{
                console.log(this.state.registerPassword)
                console.log(this.state.registerUsername)
                console.log(res.data)
                if(res.data.message) return this.setState({registerInvalid: res.data.message})
                
                //If registered successfully, then auto log in
                axios.post("/auth/login",{username: this.state.registerUsername, password: this.state.registerPassword})
                    .then(res => {
                        sessionStorage.setItem("token",res.data.token)
                        this.props.refresh()
                    })
